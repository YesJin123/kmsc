...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<a class="navbar-brand" href="#">
					<img alt="로고" src="${path}/resources/img/logo-spring.png" 
					width="50px">
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul	class="navbar-nav mr-auto">	
						...
						<li class="nav-item active">
							<a class="nav-link" href="${path}/board/boardlist.do">BoardList</a>
						</li>
					</ul>
					<c:if test="${loginStudent ==null}">
						...
						onclick="location.assign('${path}/enrollstudent.do')">
							회원가입
						</button>
					</c:if>
					<c:if test="${loginStudent!=null }">
						<span>
							<a href="${path}/student/studentview.do?id=${loginStudent.studentId}">
